...
def integrated_estimated_trajectory(ang_model_filename="models/ang_vel_regress.model",
                                    lin_model_filename="models/lin_vel_regress.model",
    ...
    lin_train_file = np.load("data/mala8lin.npy", allow_pickle=True)
    ang_train_diffs = []
    lin_train_diffs = []
    ang_train_vels = []
    lin_train_vels = []
    ...
    for diffs, vel in lin_train_file:
        lin_train_diffs.append(diffs)
        lin_train_vels.append(vel)
